    ...
    for (i=0; i< Tup->countEdgeBucket; i++)
    {
        if (Tup->buckets[i].ymax == yy)
        {
            ...
            for ( c = i ; c < Tup->countEdgeBucket -1 ; c++ )
                {
                Tup->buckets[c].ymax =Tup->buckets[c].ymax;
                Tup->buckets[c].xofymin =Tup->buckets[c].xofymin;
                Tup->buckets[c].slopeinverse = Tup->buckets[c].slopeinverse;
                }
                Tup->countEdgeBucket--;
            i--;
        }
...
{
    chdir("C:/Users/student/Desktop/16IT251/CG/lab4/polygonfill/");
